...
import { User, Calendar, Clock, Eye, Shuffle, Settings } from 'lucide-react';
...
const VacationCard = ({ employee, onViewDetail, onConvert, onEditQuota }) => {
  ...
  return (
    <Card className="vacation-card hover:shadow-lg transition-shadow duration-300 rounded-xl border-2 border-gray-200">
