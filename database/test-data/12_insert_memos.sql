...
-- 1. 个人备忘录
INSERT IGNORE INTO `memos` (`user_id`, `title`, `content`, `type`, `priority`, `is_read`, `created_at`) VALUES
...
-- 2. 部门备忘录（发送给技术部）
INSERT IGNORE INTO `memos` (`user_id`, `title`, `content`, `type`, `priority`, `target_department_id`, `created_at`) VALUES
...
-- 3. 部门备忘录接收记录
INSERT IGNORE INTO `memo_recipients` (`memo_id`, `user_id`, `is_read`, `read_at`) VALUES
