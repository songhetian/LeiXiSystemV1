...
-- 1. 全体广播
INSERT IGNORE INTO `broadcasts` (`title`, `content`, `type`, `priority`, `target_type`, `creator_id`, `created_at`) VALUES
...
-- 2. 部门广播（技术部）
INSERT IGNORE INTO `broadcasts` (`title`, `content`, `type`, `priority`, `target_type`, `target_departments`, `creator_id`, `created_at`) VALUES
('技术分享会', '本周四下午3点，技术分享会：《WebSocket实战》，欢迎参加！', 'info', 'normal', 'department', '[1]', @admin_user_id, '2024-12-06 09:00:00');

-- 3. 角色广播（管理员）
INSERT IGNORE INTO `broadcasts` (`title`, `content`, `type`, `priority`, `target_type`, `target_roles`, `creator_id`, `created_at`) VALUES
('管理员培训通知', '新版管理后台培训将于下周一上午10点举行，请所有管理员准时参加。', 'announcement', 'high', 'role', '["超级管理员", "部门管理员"]', @admin_user_id, '2024-12-06 11:00:00');

-- 4. 个人广播
INSERT IGNORE INTO `broadcasts` (`title`, `content`, `type`, `priority`, `target_type`, `target_users`, `creator_id`, `created_at`) VALUES
...
INSERT IGNORE INTO `broadcast_recipients` (`broadcast_id`, `user_id`, `is_read`, `read_at`) VALUES
